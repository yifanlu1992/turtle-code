...
plt.ylim([0,0.6])
plt.text(-0.1,0.4 ,str(error_zones[0])+'/'+str(zones[0]))
plt.text(0.9,0.43,str(error_zones[1])+'/'+str(zones[1]))
plt.text(1.9,0.47,str(error_zones[2])+'/'+str(zones[2]))
plt.text(2.9,0.41,str(error_zones[3])+'/'+str(zones[3]))
...
ax.set_xticklabels(['0~25','25~50','50~75','75<'],rotation=0)
plt.ylim([0,0.6])
plt.text(-0.1 ,0.44,str(error_zones_bottom[0])+'/'+str(zones_bottom[0]))
plt.text(0.9 ,0.31,str(error_zones_bottom[1])+'/'+str(zones_bottom[1]))
plt.text(1.9 ,0.3 ,str(error_zones_bottom[2])+'/'+str(zones_bottom[2]))
plt.text(2.9,0.41,str(error_zones_bottom[3])+'/'+str(zones_bottom[3]))
plt.xlabel('depth zones',fontsize=15)
plt.ylabel('ratio of |error|>'+str(criteria),fontsize=15)
